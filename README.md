Questo progetto è stato scritto velocemente per gestire l'azienda simulata del primo anno. Sarei molto felice se voleste studiarlo, modificarlo per quanto possibile e presentarlo ai ragazzi del primo anno come software di gestione utile ai loro scopi. Come nel caso della biblioteca anche qui sono partido dalle specifiche che sono diventate un prompt e poi codice (trovate le specifiche complete nella cartella docs).
