  ...
  <div class="col-lg-4">
    <div class="card bg-primary-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-primary text-center"><?php echo $counts['laptops_total']; ?></h2>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="card bg-success-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-success text-center"><?php echo $counts['ready']; ?></h2>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="card bg-warning-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-warning text-center"><?php echo $counts['in_progress']; ?></h2>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-lg-4">
    <div class="card bg-danger-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-danger text-center"><?php echo $counts['missing_software']; ?></h2>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="card bg-info-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-warning text-center"><?php echo $counts['to_check']; ?></h2>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="card bg-secondary-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-secondary text-center"><?php echo $counts['delivered']; ?></h2>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-lg-4">
    <div class="card bg-secondary-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-secondary text-center"><?php echo $counts['customers_total']; ?></h2>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="card bg-primary-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-primary text-center"><?php echo $counts['students_total']; ?></h2>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="card bg-info-subtle">
      <div class="card-body">
        ...
        <h2 class="card-text text-info text-center"><?php echo $counts['groups_total']; ?></h2>
      </div>
    </div>
  </div>
</div>
