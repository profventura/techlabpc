    ...
    <form method="post" action="<?php echo \App\Core\Helpers::url($item ? '/software/'.$item['id'].'/update' : '/software'); ?>">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" name="version" value="<?php echo htmlspecialchars($item['version']??''); ?>">
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 mb-3">
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="number" step="0.01" class="form-control" name="cost" value="<?php echo htmlspecialchars($item['cost']??''); ?>">
        </div>
      </div>
      <div class="mb-3">
